define(function () {
   ...
   */
   api.render = function (template, data, partials) {
    this.$el.innerHTML = Mustache.render(template, data, partials);
    this.emit(DS.Event.RENDER, this.$el);
  }

  api.throttle = function (fn, ms) {
    var timeout = null;
    return function () {
